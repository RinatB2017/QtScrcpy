...
# Project:  all.pro
# Template: subdirs
# Command: /usr/lib64/qt5/bin/qmake -o Makefile all.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = all1.0.0
DISTDIR = /home/boss/Programming/_GitHub/QtScrcpy/.tmp/all1.0.0
SUBTARGETS    =  \
		sub-QtScrcpy
...
sub-QtScrcpy-qmake_all:  FORCE
	...
	cd QtScrcpy/ && $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd QtScrcpy/ && $(MAKE) -f Makefile qmake_all
sub-QtScrcpy: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-QtScrcpy-make_first: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-QtScrcpy-all: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-QtScrcpy-clean: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-QtScrcpy-distclean: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-QtScrcpy-install_subtargets: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-QtScrcpy-uninstall_subtargets: FORCE
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall

Makefile: all.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		all.pro
	$(QMAKE) -o Makefile all.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
sub-QtScrcpy-check:
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
check: sub-QtScrcpy-check

sub-QtScrcpy-benchmark:
	@test -d QtScrcpy/ || mkdir -p QtScrcpy/
	cd QtScrcpy/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/boss/Programming/_GitHub/QtScrcpy/QtScrcpy/QtScrcpy.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
